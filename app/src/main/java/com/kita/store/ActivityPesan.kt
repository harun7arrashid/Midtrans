...
class ActivityPesan : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        startService(i) // kaya startActivity
    ...
    fun kirimData(str:String, jml:Int, catatan:String, namas_products:String){
        ...
        var registerUrl:String = "https://store.pangperhebat.my.id/historyorder.php"
    ...
    fun prosesPembayaran(str:String, pcc:PayPalConfiguration) {
        ...
        var i = Intent(this, PaymentActivity::class.java) // ketika proses pembayaran sudah selesai, nanti akan dibawa ke Payment Activity
        i.putExtra(PayPalService.EXTRA_PAYPAL_CONFIGURATION, pcc)
        i.putExtra(PaymentActivity.EXTRA_PAYMENT, ppy)
        startActivityForResult(i, 123) // kode 123 itu dari paypallnya
    }
