...
class PaymentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pesan.setOnClickListener {
            ...
            val detail = ItemDetails("NamaItemId", GlobalData.hargas.toDouble(), convertharga, GlobalData.names)
            // dimasukan kedalam Array
            val itemDetails = ArrayList<ItemDetails>()
            itemDetails.add(detail) // ini buat nampilin data detail produk
    ...
    fun uiKitDetails(transactionRequest: TransactionRequest, name: String, hp: String) {
